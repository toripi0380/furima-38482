...
ActiveRecord::Schema.define(version: 2022_11_05_095548) do
  ...
  create_table "information", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchaser_id"], name: "index_information_on_purchaser_id"
  end
  ...
  add_foreign_key "information", "purchasers"
